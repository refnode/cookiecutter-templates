...
valid_params = {
    ...
    "repository_enable_container_testing": {
        "check_enabled": True,
        "pattern": REGEX_TRUE_FALSE,
        "value": "{{ cookiecutter.repository_enable_container_testing }}",
    },
    ...
    "container_name": {
        "check_enabled": True,
        "value": "{{ cookiecutter.container_name }}",
    },
    "container_registry_prefix": {
        "check_enabled": True,
        "value": "{{ cookiecutter.container_registry_namespace }}",
    },
}
